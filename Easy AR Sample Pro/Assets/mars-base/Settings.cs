...
namespace coc
{
    ...
    public class Settings : MonoBehaviour
    {
        ...
        public Rect windowRect = new Rect(25 + 300, 20, 600, 600);
        ...
        private void AddParameters( ISettings settings )
        {
            ...
            if(Application.platform == RuntimePlatform.Android){
                folderPath = Path.Combine(Application.persistentDataPath,"settings/");
            }else if(Application.platform == RuntimePlatform.IPhonePlayer){
                folderPath = Path.Combine(Application.persistentDataPath,"settings/");
            }else{
                folderPath = Path.Combine(Application.streamingAssetsPath,"settings/");
            }
        ...
        private void OnGUI()
        {
            if(GUILayout.Button(string.Format("GUI: {0}", showGui))){
                showGui = !showGui;
            }
            if (!showGui || selectionStrings.Count == 0) 
                return;

            ResizeGUI(SettingsSizer.Instance.fontSize.Val);
            
            selectionIndex = GUILayout.SelectionGrid(selectionIndex,
                selectionStrings.ToArray(), 1);
        ...
        private void WindowFunction(int windowID)
        {
            ...
            GUILayout.Space(SettingsSizer.Instance.fontSize.Val);
        ...
        private void ResizeGUI(int fontSize)
        {
            ...
            GUI.skin.horizontalSliderThumb.fixedHeight = 80;
            GUI.skin.horizontalSliderThumb.fixedWidth = 80;
