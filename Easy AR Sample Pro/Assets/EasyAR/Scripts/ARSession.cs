...
namespace easyar
{
    ...
    public class ARSession : MonoBehaviour
    {
        ...
        public ObjectTrackerBehaviour ObjTracker;
        ...
        void Init()
        {
            ...
            if (ObjTracker != null)
            {
                index++;
                inputFrameFork.output(index).connect(i2fAdapter.input());
                i2fAdapter.output().connect(ObjTracker.Input());
                ObjTracker.Output().connect(oFrameJoin.input(index));
            }
